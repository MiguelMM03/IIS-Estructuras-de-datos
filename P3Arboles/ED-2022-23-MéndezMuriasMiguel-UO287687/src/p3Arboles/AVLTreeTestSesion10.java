...
class AVLTreeTestSesion10 {
	...
	void testSesion10() {
		...
		try
		{
			...
			sesion9AddLeftYRecorridos(pw);
			sesion9AddRightYRecorridos(pw);
	...
	private void sesion9AddLeftYRecorridos(PrintWriter pw) {
	...
	private void sesion9AddRightYRecorridos(PrintWriter pw) {
		AVLTree<Integer> t = new AVLTree<Integer>();
		int n=0;
